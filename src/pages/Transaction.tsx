...
const arr: DataType[] = [
  {
    ...
    action: <Link to="/admin/transaction/patel">Manage</Link>,
  },
  {
    user: "patel",
    amount: 4043,
  ...
  },
  {
    ...
    discount: 220,
    quantity: 7,
    status: <span className="green">Success</span>,
    action: <Link to="/admin/transaction/patel">Manage</Link>,
  },
];
...
const Transaction = () => {
  ...
  const Table = useCallback(
    TableHOC<DataType>(columns, data, "transaction_table", "Transaction", true),
    []
  );
