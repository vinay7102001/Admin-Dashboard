...
const ProductManagement = () => {
  ...
  const [price, setPrice] = useState<number>(54466);
  const [stock, setStock] = useState<number>(47);
  ...
  return (
    <div className="adminContainer">
      ...
      <div className="add_new_product">
        <section>
          {updatedStock > 0 ? (
            <strong className="green">{updatedStock} Availabel</strong>
          ) : (
            <strong className="red">Not-Available</strong>
          )}
          <div className="product_managment">
            <p>ID - {id}</p>
            <img src={updatedPhoto} alt="laptop photo" />
            <div>
        ...
        <article>
          <form>
            ...
            <button type="submit" onClick={UpdatedData}>
              Update
            </button>
          </form>
